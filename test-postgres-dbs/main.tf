...
module "keycloak-pg-db" {
  ...
  instance_name         = "test-keycloak-pg"
  database_size         = "200"
  ssh_authorized_key    = var.ssh_authorized_key
...
module "sonarqube-pg-db" {
  ...
  instance_name         = "test-sonarqube-pg"
  database_size         = "200"
  ssh_authorized_key    = var.ssh_authorized_key
...
module "confluence-pg-db" {
  ...
  instance_name         = "test-confluence-pg"
  database_size         = "200"
  ssh_authorized_key    = var.ssh_authorized_key
...
module "mattermost-pg-db" {
  ...
  instance_name         = "test-mattermost-pg"
  database_size         = "200"
  ssh_authorized_key    = var.ssh_authorized_key
